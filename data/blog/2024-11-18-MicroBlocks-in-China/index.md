...
h1, h2, h3, h4, h5, h6 {
  ...
  margin-top: 1em;
  margin-bottom: 0.5em;
  color: #24292f; /* GitHub的默认文字颜色 */
}

/* 具体标题样式 */
h1 {
  font-size: 2em;
  border-bottom: 1px solid #eaecef; /* 添加底线 */
...
> 你无法在前瞻中连接这些点，只有在回顾时才能串联起它们 -- [乔布斯《毕业典礼演讲》](https://www.bilibili.com/video/BV1oW411h7Ea/)

和许多其他的故事一样，开始于**偶然**.

当时我在[非营利组织 CodeLab](https://www.CodeLab.club/blog/2020/09/25/about-CodeLab-2020) 里构建[可编程空间](https://www.CodeLab.club/blog/2020/04/29/%E5%8F%AF%E7%BC%96%E7%A8%8B%E7%A9%BA%E9%97%B4/):
...
为了让房间里的各种事物变得可编程, 我们经常需要接管各种硬件设备, 为此, 我们构建了[CodeLab Adapter](https://adapter.CodeLab.club/)

> 致力于连接万物，无论是软件还是硬件，无论是 AI、开源硬件、现实世界的物体、还是虚拟世界的动画角色，接入 CodeLab Adapter，皆可彼此互动。

有一天, [CodeLab 成员 @kaikai](https://www.CodeLab.club/blog/2021/06/28/CodeLab%E7%BA%AA%E4%BA%8B#%E5%85%A8%E8%81%8C%E5%B0%8F%E4%BC%99%E4%BC%B4) 提出他遇到一个项目, 在硬件编程方面做得比我们更好。

这个项目叫 MicroBlocks.

起初, 自尊心让我不愿承认人家做得更好. 但随着深入使用，我意识到岂止是「做得更好」，简直是里程碑式地更好! 我确信它是未来，足以在这个领域开创 Scratch 那样的辉煌。

于是我便参与其中. 既像黑客那样为 MicroBlocks 贡献代码，又像布道者那般热衷于[分享使用 MicroBlocks 的愉快体验](https://wwj718.github.io/tags/microblocks/)，并试着在国内推广它。

几年的合作后, 正式成为 MicroBlocks 团队成员. 我在 MicroBlocks 项目上的主要工作包括:

- 将 MicroBlocks 本地化, 将其[部署在中国](https://microblocksfun.cn), 并将爱好者聚集在讨论小组(讨论小组非常活跃! 邵悦是其中最积极的一位!)
- 提出[无线编程的功能需求](https://bitbucket.org/john_maloney/smallvm/issues/305/enable-microblocks-ide-to-support), 基于 [NimBLE](https://github.com/h2zero/NimBLE-Arduino) 制作了最初原型, 并与 John Maloney 一起将其发展到稳定可靠, 最终成为 MicroBlocks 的杀手级功能.
- [破解 OctoStudio](https://wwj718.github.io/post/%E7%BC%96%E7%A8%8B/extend-octostudio/), 使其能够与 MicroBlocks 互操作
- 构想了[基于 url 分享项目的机制](https://bitbucket.org/john_maloney/smallvm/issues/251/share-project-with-url)(这个功能由 John Maloney 实现)
- 构建了 MQTT 等积木库
- 为 MicroBlocks 制作了[各种语言的客户端](https://wwj718.github.io/post/%E7%BC%96%E7%A8%8B/microblocks-wireless-programming/#%E5%A4%9A%E8%AF%AD%E8%A8%80%E5%AE%A2%E6%88%B7%E7%AB%AF): Python, JavaScript, Snap! , Scratch...
- 构建了[支持无线编程的离线版 MicroBlocks](https://wwj718.github.io/post/%E7%BC%96%E7%A8%8B/offline-microblocks-webapp/) (适用于网络不好的学校环境)
- [在博客中分享使用 MicroBlocks 的经验](https://wwj718.github.io/tags/microblocks/)
- 与邵悦一起, 在 [MicroBlocks 周末分享会](https://space.bilibili.com/174017128/channel/collectiondetail?sid=915341)中分享 MicroBlocks 相关内容
- 与企业以及爱好者合作, 推动 MicroBlocks 在国内的使用
- ...
...
2021 年 12 月 8 日种瓜分享了第一个 MicroBlocks 项目: [用 micro:bit 接管 xlight](https://wwj718.github.io/post/%E7%BC%96%E7%A8%8B/dynablocks-microbit-xlight/) 的项目。

当 [MicroBlocks 中文网站](https://microblocksfun.cn/)上线后，我觉得应该做一些事让更多人了解这么有意思的 MicroBlocks 平台。

在 2022 年开始[每周六做关于 MicroBlocks 的分享](https://space.bilibili.com/174017128/channel/collectiondetail?sid=915341)，没想到 MicroBlocks 这么好玩, 就一直坚持到了现在，目前已经发布到 B 站的视频有 90 多期了。之后除了 MicroBlocks , 也分享 Snap! 以及其他与个人计算有关的话题。但绝大多数的分享还是围绕 MicroBlocks 展开。
...
![](microblocks-in-china/shao0.jpg)

RTE 展会:

![](microblocks-in-china/shao1.jpg)
...
![](microblocks-in-china/shao2.jpg)

![](microblocks-in-china/shao4.jpg)

### 课题教学: 在小学课程中使用 MicroBlocks + micro:bit

![](microblocks-in-china/shao5.jpg)
...
![](microblocks-in-china/shao6.jpg)

### 2024 M5Meetup

在 M5Meetup 上作为 M5 社区一员做了“当 M5Stack 遇到 MicroBlocks” 的分享。

![](microblocks-in-china/shao7.jpg)

# MicroBlocks 爱好者怎么说

> 如果你想走得快，一个人走; 如果你想走得远，一群人走。

MicroBlocks 爱好者们在 [这份协作文档上](https://docs.qq.com/doc/DSFh6U3dFdElxckVj)分享了他们与 MicroBlocks 的故事, 我将这些故事摘录到本文中(大致以大家接触 MicroBlocks 的前后时间排序).
...
与 MicroBlocks 的相遇是通过种瓜 2021 年中的一次分享会（[MicroBlocks 编程案例: 使用 micro:bit 接管 xlight](https://wwj718.github.io/post/%E7%BC%96%E7%A8%8B/dynablocks-microbit-xlight/)），在使用 MicroBlocks 前，我主要使用 MakeCode 作为硬件的编程软件，每次做项目时需要接线到主板下载程序再反复插拔进行调试。记得那时候只能作为最基础的用户，等待开发者和硬件公司发布对应传感器的扩展才能去使用，虽然那时候我也做了一些关于「Makecode 构建扩展流程」的调研，不过对于那时候的我有点不太友好，面对如此陌生的内容，一时难以理解，渐渐的没什么兴趣就会产生抗拒。
...
<iframe src="//player.bilibili.com/player.html?isOutside=true&aid=220706247&bvid=BV1a8411j7Qb&cid=907445022&p=1&autoplay=0" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true"></iframe>

2. 六足机器人

<iframe src="//player.bilibili.com/player.html?isOutside=true&aid=113470234165735&bvid=BV1oMmaYCEep&cid=26730301954&p=1&autoplay=0" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true"></iframe>

### 相识

在使用 MicroBlocks 做项目的过程中，它的实时性给项目的调试带来很多便利，但对于一个新传感器（ MicroBlocks 没有直接可使用的积木库）或和新的硬件需要在 MicroBlocks 上使用时，如果缺少对应的 ubl 库就无法享受平台带来的**交互式编程、多任务处理、拔掉插头即可启动程序**等好处. 这时我就有了更进一步学习欲望，而且 MicroBlocks 又给我了一个大大的惊喜，原来 MicroBlocks 很多的传感器积木库都是都过积木拼搭出来的，这些不就是很好的学习的资料吗？于是我学习了种瓜编写的一个积木库（悟空扩展板）

![](microblocks-in-china/yinxi1.jpg)

经过一段时间的学习，我也开始共享了一些积木库「六足机器人」、「英荔比特」、「哪吒套装」、「XGO」、「麦克纳姆轮小车」

![](microblocks-in-china/yinxi2.png)

<iframe src="//player.bilibili.com/player.html?isOutside=true&aid=113470301342765&bvid=BV1EwmaYUEf1&cid=26730561552&p=1&autoplay=0" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true"></iframe>

随着 MicroBlocks 中国社区的慢慢壮大，我也参与到了其中，也在社区贡献了一些积木库:

![](microblocks-in-china/yinxi3.jpg)

随着 MicroBlocks 的不断发展，我从中也学习了非常多，我所在的英荔公司也全面拥抱 MicroBlocks，我也为每一届赛事和课程所需的传感器编写了对应的积木库，到目前已近超过了 70 余个，后续也计划在中文社区上进行分享。

![](microblocks-in-china/yinxi3.png)

<iframe src="//player.bilibili.com/player.html?isOutside=true&aid=113470234168949&bvid=BV1dMmaYCE1m&cid=26730300293&p=1&autoplay=0" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true"></iframe>

MQTT 系列项目:

1. [烟花灯带](https://www.bilibili.com/video/BV1VYmhYBELd/?vd_source=ef424c5accd5a87e6cc52e64b3417647)（scratch 与 MicroBlocks 相互通讯）
2. [音乐灯带](https://www.bilibili.com/video/BV16R4y1y7zC/?vd_source=ef424c5accd5a87e6cc52e64b3417647)（scratch 与 MicroBlocks 相互通讯）
3. [手势灯带](https://www.bilibili.com/video/BV1iD4y1a7R2/?vd_source=ef424c5accd5a87e6cc52e64b3417647)（Python 与 MicroBlocks 相互通讯）
4. [嘿！Siri](https://www.bilibili.com/video/BV1oMmaYCEAj/?vd_source=ef424c5accd5a87e6cc52e64b3417647)（Siri 与 MicroBlocks 相互通讯）
5. [RVR databot 控制器](https://www.bilibili.com/video/BV1nwmaYUEwX/?vd_source=ef424c5accd5a87e6cc52e64b3417647)（scratch 与 MicroBlocks 相互通讯）
6. [颜色识别器](https://www.bilibili.com/video/BV1a8411j7Qb/?vd_source=ef424c5accd5a87e6cc52e64b3417647)（Python 与 MicroBlocks 相互通讯）
...
![](microblocks-in-china/yinxi9.jpg)

最后再分享一些 Demo:

1. [智能灯光画](https://www.bilibili.com/video/BV1EPmaY7E3R/?vd_source=ef424c5accd5a87e6cc52e64b3417647)（使用 MQTT 让 scratch 与 MicroBlocks 相互通讯）
2. [隔空钢琴](https://www.bilibili.com/video/BV1oMmaYCEez/?vd_source=ef424c5accd5a87e6cc52e64b3417647)
3. [正中靶心](https://www.bilibili.com/video/BV1fPmaYjEUg/?vd_source=ef424c5accd5a87e6cc52e64b3417647)（Python 与 MicroBlocks 相互通讯）
...
![](microblocks-in-china/tom1.jpg)

MicroBlocks 除了可以用来设计小的作品还可以用来设计大的真实的产品原型。

去年开始，我尝试让学生设计载人小车作品，**由于 MicroBlocks 提供了蓝牙无线编程方式**，使得调试载人小车的过程非常方便。而且**由于 MicroBlocks 支持多任务并行处理**，用户可以实现较复杂的功能。

使用 MicroBlocks+ESP32 开发板+移动端 AI，载人小车实现了既可手动驾驶又可自动驾驶功能，学生们非常喜欢这个项目!

![](microblocks-in-china/tom2.jpg)

今年 10 月, 我的这个载人自动驾驶小车项目获得全国第十届全国中小学实验教学说课活动现场展示机会，在展示现场受到众多老师的围观，大家都对这个项目非常感兴趣。

![](microblocks-in-china/tom3.jpg)

![](microblocks-in-china/tom4.jpg)
...
![](microblocks-in-china/patch5.jpg)
...
- [798 园区寻宝](https://cuzo.sanzhi.org.cn/index.php?m=topic&a=detail&tid=24292)
- [塞隆创意园寻宝](https://cuzo.sanzhi.org.cn/index.php?m=event&a=detail&eid=19594)
- [丽泽商务区金中都遗址寻宝](https://cuzo.sanzhi.org.cn/index.php?m=event&a=detail&eid=19648)
- [环形铁路寻宝](https://cuzo.sanzhi.org.cn/index.php?m=event&a=detail&eid=19623)
- [亮马河畔寻宝](https://cuzo.sanzhi.org.cn/index.php?m=topic&a=detail&tid=23911)
- [美术馆解谜寻宝](https://cuzo.sanzhi.org.cn/index.php?m=topic&a=detail&tid=23897)

一些照片:

![](microblocks-in-china/patch.jpg)

一个需要解谜的藏宝图:

![](microblocks-in-china/patch2.png)
...
<iframe src="//player.bilibili.com/player.html?isOutside=true&aid=914965990&bvid=BV1iu4y1v7SD&cid=1240341073&p=1&autoplay=0" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true"></iframe>

在讨论中基本确定了这些事项：

1. OLED 中图片显示的方法是图片点阵化并记录为 16 进制字符串，MicroBlocks 将字符串还原为点阵显示出来
2. 利用 MicroBlocks 官网 wiki 上的 Snap!示例，可以将图片生成正确的字符串用于 MicroBlocks 显示，示例见下： [SNAP To MicroBlocks - Image & Code Transfer](https://wiki.microblocks.fun/en/snap/snap2mb_img_code)
...
![](microblocks-in-china/patch3.gif)

于是根据这个研究成果，我们用 Scratch 完成了 [自动获取汉字 16 点阵字模](https://create.CodeLab.club/projects/53070/) 的扫描方案.

还有这个 [16 点阵字体设计工具](https://create.CodeLab.club/projects/66585/)

并参照 OLED 图片显示的方法，在 MicroBlocks 里实现了 TFT 屏汉字显示的积木库：

![](microblocks-in-china/patch4.png)
...
![](microblocks-in-china/ye1.jpg)

像素动画创作项目:

![](microblocks-in-china/ye2.png)
...
![](microblocks-in-china/mei1.jpg)

![](microblocks-in-china/mei2.jpg)

![](microblocks-in-china/mei3.png)
...
![](microblocks-in-china/zeng6.jpg)
...
<iframe src="//player.bilibili.com/player.html?isOutside=true&aid=365052282&bvid=BV1294y1L7Qc&cid=1308261614&p=1&autoplay=0" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true"></iframe>
...
<iframe src="//player.bilibili.com/player.html?t=41.3&isOutside=true&aid=1655991740&bvid=BV15E421A7NH&cid=1591822785&p=1&autoplay=0" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true"></iframe>
...
![](microblocks-in-china/zeng5.png)

## Bingo

1. 在科技馆开一些公益课推广使用 MicroBlocks, 如: 2024 年暑假在台州市（地市级）科技馆使用 Microblocks 开展了"奇思妙想创客营"科苗班的公益科技培训，活动开始[官方报道](https://www.kepuchina.cn/article/articleinfo)

![](microblocks-in-china/bingo1.jpg)

2. 在教师中融合《信息科技(浙教版)》教材推广 Microblocks 进行课堂实验。

## CoCube 机器人-梁帅

2024 年 7 月，**中美青年创客大赛上海赛区**组织了为期两天的中小学体验赛道中美创客公益特训营，十几名孩子每个人控制一台 CoCube 机器人，用 MicroBlocks 控制小车，共同编出 Co-Making the Future 的队形。
...
![](microblocks-in-china/shuai1.jpg)
...
![](microblocks-in-china/shuai2.jpg)
...
![](microblocks-in-china/shuai3.png)
...
![](microblocks-in-china/shuai4.jpg)
...
![](microblocks-in-china/shuai5.jpg)
...
![](microblocks-in-china/shuai7.jpg)
...
![](microblocks-in-china/shuai8.jpg)
...
![](microblocks-in-china/shuai9.jpg)
...
![](microblocks-in-china/shuai10.jpg)
...
![](microblocks-in-china/shuai11.jpg)
...
![](microblocks-in-china/shuai12.jpg)

2024 年 9 月，基于 CoCube 和 MicroBlocks 的成功应用，我们撰写了会议论文《[CoCube: A Tabletop Modular Multi-Robot Platform for Education and Research](https://www.cocubefun.com/zh/)》，这篇论文应该是第一篇将 MicroBlocks 用于多智能体的论文。论文中有一小节取名为“Meet MicroBlocks”，致敬了 John Maloney 论文《[Programs in the Palm of your Hand](https://dl.acm.org/doi/10.1145/3311927.3323138)——How Live Programming Shapes Children's Interactions with Physical Computing Devices》中的对应章节。
...
![](microblocks-in-china/shuai13.jpg)

### 使用感受

#### 1.体会到了开源共创的意义

MicroBlocks 好多新的功能需求，最初都来自于一线的用户。CoCube 从 2024 年 6 月正式结合 MicroBlocks，每举办一次活动都能收集到不少新的用户反馈，并在下次活动前对其功能完成优化。例如，用同一台电脑控制多个 CoCube、用键盘控制 CoCube，都来源于用户的创意和需求。
让我感觉更有意思的一点是，这些创意想法通过我们实现、变成 CoCube 的基础功能后，之后的用户可以站在巨人的肩膀上，又会有更多的想法迸发了。

#### 2.低门槛、高天花板、宽围墙

种瓜在[比较图形化硬件编程平台](https://wwj718.github.io/post/%E7%BC%96%E7%A8%8B/compare-hardware-blocks-platforms/)的博文中，谈到 MicroBlocks 是最具“低门槛、高天花板、宽围墙”特点的图形化编程平台。在 CoCube 与 MicroBlocks 结合并迸发新的创意的过程中，我自己也深切的体会到了这一点。

CoCube 用在高校院所的科研场景，例如多机器人编队集群，经过适当的调整，就可以变成孩子们的趣味课程；同时孩子们提出的键盘控制 CoCube，也启发我们可以基于此做一些 AI 算法的研究。

## 一土学校-俊俊

![](microblocks-in-china/jun2.jpg)

俊俊是一土学校 STEAM 课程老师, 他在 [我在一土学校运营 STEAM “社群”的那些事 ～](https://jcn9o20wl9oq.feishu.cn/wiki/IFRSwnKwAilbYmk5VhwcxkKXnyc) 一文里, 细致地分享了将 MicroBlocks 带入一土学校的前因后果, 推荐感兴趣的朋友阅读原文! 这里摘录其中的部分.

### 将 MicroBlocks 带入一土学校 STEAM 课程

![](microblocks-in-china/junjun.png)

在 23 年春季学期，我在一土教初中和高中（[具体看这里](https://chenjunyan1.github.io/blog/2024/post-yitu/)）。虽然我擅长前后端开发，但对硬件的了解还算个新手。
...
在一土的课堂上，我会和孩子们一起玩 MicroBlocks + 硬件 + 软件 + AI。而在课外我自己有时候甚至玩到凌晨三四点，做出一些非常好玩的项目（[看这里](https://chenjunyan1.github.io/blog/2023/post-chatgpt/)），比如创作音乐和灯光的魔幻组合、导航回家的小工具、用 Siri 开灯等等。相比传统写代码，MicroBlocks 有很多优势，比如：
...
- MicroBlocks 可以与 [CodeLab 平台](https://create.codelab.club/)联动，还可以与 [TeachableMachine](https://wwj718.github.io/post/%E5%B0%91%E5%84%BF%E7%BC%96%E7%A8%8B/adapter-teachable-machine/) 的进行连接。

<iframe src="//player.bilibili.com/player.html?isOutside=true&aid=113503469898220&bvid=BV1SqUWY1EFo&cid=26824542933&p=1&autoplay=0" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true"></iframe>
...
<iframe src="//player.bilibili.com/player.html?isOutside=true&aid=113503637603841&bvid=BV16jUWYFEcP&cid=26825133524&p=1&autoplay=0" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true"></iframe>

<iframe src="//player.bilibili.com/player.html?isOutside=true&aid=1705038876&bvid=BV14T421i7s6&cid=1561116959&p=1&autoplay=0" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true"></iframe>

<iframe src="//player.bilibili.com/player.html?isOutside=true&aid=113503486608980&bvid=BV18iUWYjEzL&cid=26824606812&p=1&autoplay=0" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true"></iframe>

<iframe src="//player.bilibili.com/player.html?isOutside=true&aid=1105009913&bvid=BV1Dw4m1U7wE&cid=1560728115&p=1&autoplay=0" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true"></iframe>

<iframe src="//player.bilibili.com/player.html?isOutside=true&aid=113503486611101&bvid=BV18iUWYjEcr&cid=26824608149&p=1&autoplay=0" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true"></iframe>

<iframe src="//player.bilibili.com/player.html?isOutside=true&aid=113503486611164&bvid=BV18iUWYjEFi&cid=26824609004&p=1&autoplay=0" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true"></iframe>
...
![](microblocks-in-china/ji2.jpg)

<video width=80% src="https://scratch3-files.just4fun.site/ji4.mp4" controls="controls"></video>
...
![](microblocks-in-china/ji3.jpg)

<video width=80% src="https://scratch3-files.just4fun.site/ji5.mp4" controls="controls"></video>

<video width=80% src="https://scratch3-files.just4fun.site/ji6.mp4" controls="controls"></video>

<video width=80% src="https://scratch3-files.just4fun.site/ji7.mp4" controls="controls"></video>
...
在 24 年 3 月的一次分享会上，得知了[蓝牙键盘固件](https://wwj718.github.io/post/%E7%BC%96%E7%A8%8B/microblocks-wireless-makeymakey/)，恰好之前有在 b 站上刷到有人给残障人士制作使用脚控制的键盘。在成本可控的情况下，可扩展性与便捷性没有自己 diy 方便，于是就有了这个想法。利用简单的按钮，就可以轻松的制作一个自定义的蓝牙键盘，可以是工作上的快捷键，可以是专业软件的自定义键盘，可以是给残障人士使用的脚控键盘，甚至可以是一个简易的游戏手柄。

<iframe src="//player.bilibili.com/player.html?isOutside=true&aid=1403669615&bvid=BV1Zr421g7u4&cid=1517752989&p=1&autoplay=0" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true"></iframe>
...
![](microblocks-in-china/fang1.jpg)
...
<video width=80% src="https://scratch3-files.just4fun.site/fang2.mp4" controls="controls"></video>

#### 3.利用文件系统实现在 esp32 上多网页的切换

将不同的网页存储到文件文件系统中，通过超链接到形式可以打开各个不同的页面，在一些智能家居的项目中希望展示一些数据可能用得上。

<video width=80% src="https://scratch3-files.just4fun.site/fang3.mp4" controls="controls"></video>
...
<iframe src="//player.bilibili.com/player.html?isOutside=true&aid=113453037521755&bvid=BV1gWDrYKEsM&cid=26686259436&p=1&autoplay=0" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true"></iframe>

[这篇文章](https://blog.csdn.net/weixin_44549969/article/details/143674853)里分享了详细的制作流程
...
![](microblocks-in-china/Dolphin1.jpg)
...
![](microblocks-in-china/Dolphin2.jpg)
...
![](microblocks-in-china/Dolphin3.jpg)
...
![](microblocks-in-china/Dolphin4.jpg)
...
![](microblocks-in-china/leon1.png)

![](microblocks-in-china/leon2.png)
...
[英荔教育](https://aimaker.space)是中国第 1 家拥抱 MicroBlocks 的企业, MicroBlocks 在中国的第 1 家企业合作伙伴, 也是为 MicroBlocks 提供捐赠的第 1 家中国企业.

![合作伙伴](microblocks-in-china/aimaker-microblocks.png)

英荔教育在公司的许多项目中深度使用 MicroBlocks , 从**课程内容**到**体验项目**, 从**NOC 赛事**到**AI 运动会**.

### NOC 赛事

英荔教育与 MicroBlocks 团队的协作始于 [NOC 赛事](https://competition.aimaker.space/NOC2024/).

这是赛事相关的一些数据(每支队伍有 1 名指导老师和 2 名学生)

<!--
|        | 21-22 赛季 | 22-23 赛季 | 23-24 赛季 |
| ------ | ---------- | ---------- | ---------- |
| 队伍数 | 378        | 410        | 892        |
-->
...
英荔教育在**21-22 赛季**首次将 NOC 赛事平台从微软的 [MakeCode](https://makecode.microbit.org) 切换到了 MicroBlocks.

这项合作为英荔教育和 MicroBlocks 双方都带来了许多收益.

在英荔方面, MicroBlocks 用户级别的**可扩展性**为英荔带来了巨大价值: 积木库的编写和发布变得极其简单, 完全无需开发团队的介入, 产品团队自己就能完成, 甚至任何的普通用户都能完成! 教学方面的价值也是巨大的, 由于用户使用的积木是在图形化环境中定义的, 这使得好奇的学生可以自由探索, 根据自己的兴趣, 在图形化环境中去弄懂系统底层是如何工作的. 这在其他任何图形化环境中(也许 Snap! 除外)都是不可思议的!

此外, MicroBlocks 是自由软件, 其出色的架构使它极为灵活, 企业可以根据自己的需求, 在任何层面按照自己的意愿定制它, 因此英荔可以快速地推出自己的编程套件, 为它量身定制 MicroBlocks 虚拟机, 并在用户环境中为它编写驱动库, 这些工作的大部分都是由产品团队完成的, 换句话说**是由非技术背景的用户完成的**!

在 MicroBlocks 方面, 来自英荔的赛事应用场景和早期用户反馈, 帮助 MicroBlocks 发现了许多潜在 bug , 并推动了许多新的功能特性.

举例来说, 光是英荔团队中的 1 位成员就报告并协助 MicroBlocks 团队解决了[这么多问题](https://bitbucket.org/john_maloney/smallvm/issues?reported_by=61b99cbaacc926006a015293), 这些改进最终合并到主分支, 不仅使英荔的用户收益, 也是使 MicroBlocks 全球社区的所有用户受益.

![](microblocks-in-china/xixicarry-issues.png)

一些导致 MicroBlocks 进行重大改进的其他反馈和讨论:

![](microblocks-in-china/elite1.jpg)

<!--
![](microblocks-in-china/UI-lagging-problem.png)

![](microblocks-in-china/User-feedback.png)

![](microblocks-in-china/MicroBlocks-code-download-optimization.png)

![](microblocks-in-china/Wireless-programming-firmware-in-competition-scenarios.png)
-->
...
![](microblocks-in-china/competition3.jpg)

![](microblocks-in-china/competition1.jpg)

英荔与 MicroBlocks 的合作很好地展示了: **企业如何受益于开源社区, 又如何回馈开源社区**.

<!--
- MicroBlocks 的这些强大功能都是在英荔与MicroBlocks的协作中完成的, 讨论双方的**合作**
    在issue(xixi, yongyu, 以及邮件)中找共同推动的东西
    需求推动的改进
    MicroBlocks 有很多关键性能的改进建议, 都来自英荔教育早期的白名单赛事的用户反馈

    赛事介绍
        https://mail.google.com/mail/u/0/#search/elite+microblocks/FMfcgzGtwDDZXKVSxfTPcWjsNdfFMmQg
-->
...
![](microblocks-in-china/Sports-Day3.jpg)
![](microblocks-in-china/Sports-Day1.jpg)
![](microblocks-in-china/Sports-Day2.jpg)

以`划艇比赛`为例, 对其做个简单介绍:

> 在**脚蹬拉力器**上方平防止一个「Elite Core(基于 esp32)」，体验者用力拉伸脚蹬拉力器时，其上传感器的加速度会发生变化，舞台区的虚拟角色做出相应划船动作，拉伸脚蹬拉力器检测到的速度越快, 虚拟角色的划船频率便越快，抵达终点用时最少者优胜。
...
英荔教育连续四年作为青少年机器人竞赛的器材提供商，我们承办的比赛包括 2021-2022 年少年硅谷——全国青少年人工智能教育成果展示大赛、2022-2024 学年全国中小学信息技术创新与实践大赛（简称 NOC）。
2021 年，我们使用的器材是 micro:bit 系列的机器人竞赛器材，当然我们无容置疑地选择了 MakeCode 作为编程工具，它是微软针对 micro:bit 做的一个免费开源编程平台。选择它的原因不外乎两点：
...
![](microblocks-in-china/ELECFREAKS.jpg)

[ELECFREAKS](https://www.elecfreaks.com/) 自 2011 年在中国深圳成立以来，专注于 micro:bit 开发套件和配件的全方位服务，包括研究、制造和销售。作为 BBC micro:bit 基金会的官方合作伙伴及中国区的交付伙伴，我们在 2023 年拓展了产品线，涉足树莓派系列产品。我们推出了基于 Raspberry Pi Pico/Pico W 的 WuKong2040 扩展板，并基于此开发了 Wukong2040 Inventor's Raspberry Pi Kit。在选择图形化编程平台以支持这些新套件时，我们经过深思熟虑后选择了 MicroBlocks 平台。
...
![](microblocks-in-china/ELECFREAKS2.jpg)

### 陆吾智能

![](microblocks-in-china/xgo2.jpg)
...
近期, MicroBlocks 与 [MIT APP Inventor](https://www.appinventorfoundation.org/news) 正在[展开合作](https://microblocks.fun/blog/2024-11-08-appinventor-intro/)

> 想象一下，有了可以与现实世界互动的移动应用，你会做些什么。你可以通过手机控制一只**机器狗**或可怕的万圣节灯光秀。或者，应用可以告诉你家里的植物什么时候缺水，然后让你只需点击一下按钮就可以浇水。

XGO 机器人成为这项合作中备受欢迎的新宠:

![](microblocks-in-china/xgo1.jpg)
...
![](microblocks-in-china/ICBricks2.jpg)
...
![](microblocks-in-china/ICBricks3.jpg)

# 更多合作

## 中美青年创客大赛上海赛区

MicroBlocks 正与 **[中美青年创客大赛上海赛区](https://mp.weixin.qq.com/s/5U69vRxzKbIwGV_S2zMUMQ)组委会** 建立合作:
